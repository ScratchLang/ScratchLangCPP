...
void add_to_zip(mz_zip_archive &zip_archive, const string &path,
                const string &prefix = "")
{
...
void extract_zip(const string &zip_path, const string &dest_path)
{
...
void error(string text) { cout << RED << "Error: " << text << NC << endl; }

void error(const char *text) { cout << RED << "Error: " << text << NC << endl; }
